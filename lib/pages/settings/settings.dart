        ...
        child: ListView(
          ...
          children: <Widget>[
            ...
            ListTile(
              ...
              title: Wrap(children: <Widget>[DropdownButton(
                value: _langControl,
                onChanged: (value) {
                  setState(() {
                    _langControl = value;
              ...
              title: Wrap(
                children: <Widget>[DropdownButton(
                  ...
                  items: currencies.map((curr){
                    return DropdownMenuItem(
                      value: curr,
                      child: Align(child:Text(setLang[curr][lang]),alignment: Alignment.centerRight,),
                    );
                  }).toList(),
                )],
              ),
            ...
            Container(
              ...
              child: Row(
                children: <Widget>[
                  RaisedButton(
                    child: Text(genLang['save'][lang], style: text['buttonText'],),
                    color: Colors.green,
                    onPressed: (){
